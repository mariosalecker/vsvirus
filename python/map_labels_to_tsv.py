...
path_prodigy_labeled = 'specs/kurzarbeit_voranmeldung_de_p1.json'
...
def scale(annotation_list, doc_width, doc_height):
    result = []
    for annotation in annotation_list:
        factor_width = doc_width / annotation.page_width
        factor_height = doc_height / annotation.page_height
        scaled_rect = Rectangle(annotation.rectangle.left * factor_width, annotation.rectangle.top * factor_height, annotation.rectangle.width * factor_width, annotation.rectangle.height * factor_height)
        scaled = Annotation(annotation.filename, annotation.page_num, annotation.page_width, annotation.page_height, annotation.label, scaled_rect)
...
doc_name = 'kurzarbeit_voranmeldung_de'
...
for tsv_file in documents_all:
    ...
    scaled_annotations = scale(doc_annotations, doc_width, doc_height)
